...
class Shuffler:
    ...
    def train_test_splitter(self, 
        ...
        return id_train_array, id_test_array
...
shuffle = Shuffler(0.8, n_repeats=1)
bear_id_train, bear_id_test = shuffle.train_test_splitter(bear_id_0.bearing_id, bear_id_1.bearing_id) # get 100 train\test id splits
subset = shuffle.parter(bear_id_0.bearing_id) # get 100 different id subsets